...
#saveRDS(xgb.fit , file.path(path,"03_results/xgboost/xgb_HCV_counts_freq_1_50.rds"))
...
write.csv(as.data.frame(pred_tr), file.path(path,"03_results/xgboost/predictions_tr_xgb_HCV_counts_freq_1_50.csv"))
```
...
write.csv(as.data.frame(pred_ts), file.path(path,"03_results/xgboost/predictions_ts_xgb_HCV_counts_freq_1_50.csv"))
pr_grpl <- perf_binned_perf_curve(pred_ts, 20,"rec", "prec")
plot(pr_grpl$curve$rec_binned, pr_grpl$curve$prec)
write.csv(pr_grpl$curve, file.path(path,"03_results/xgboost/PR_xgb_HCV_counts_freq_1_50.csv"))
```
...
```{r}
pred_ts <- predict(xgb.fit, dataset_ts)
write.csv(as.data.frame(pred_ts), file.path(path,"03_results/xgboost/predictions_ts_xgb_HCV_counts_freq_1_50_2.csv"))
pr_grpl <- perf_binned_perf_curve(pred_ts, 20,"rec", "prec")
plot(pr_grpl$curve$rec_binned, pr_grpl$curve$prec)
write.csv(pr_grpl$curve, file.path(path,"03_results/xgboost/PR_xgb_HCV_counts_freq_1_50_2.csv"))
```
