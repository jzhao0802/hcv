...
#LR training predictions
pred_ts_LR <- read.csv(file.path(path, "03_results/LR/final/predictions_ts_lr_HCV_counts_flags_freq_1_50_2.csv"))
pred_ts_RF <- read.csv(file.path(path, "03_results/rf/predictions_ts_rf_HCV_counts_freq_1_50_2.csv"))
pred_ts_XGB <- read.csv(file.path(path, "03_results/xgboost/predictions_ts_xgb_HCV_counts_freq_1_50_2.csv"))
...
write_rds(xp_ts, file.path(path, "/01_data/ensemble_lr_rf_xgb_ho2.rds"))
